...
export default function Navbar() {
  ...
  return (
    <nav className="bg-gradient-to-br from-purple-600 to-indigo-800 fixed left-0 top-0 h-screen w-64 p-6 rounded-r-2xl">
      ...
      <div className="space-y-2.5">
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              <Icon className={`w-5 h-5 ${isActive ? 'text-indigo-00' : ''}`} />
